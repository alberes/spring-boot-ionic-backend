--mysql://b6123d8a7220dd:2dc1d0d9@us-cdbr-east-06.cleardb.net/heroku_d2ce9b3b217009d?reconnect=true

--mysql --host=us-cdbr-east-06.cleardb.net --user=b6123d8a7220dd --password=2dc1d0d9 --reconnect heroku_d2ce9b3b217009d < curso_spring.sql
...
CREATE TABLE `pedido` (
  ...
  `cliene_id` int(11) DEFAULT NULL,
  `endereco_entrega_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKs7yibycqpxfpnv92j1dl8r1fi` (`cliene_id`),
  ...
  CONSTRAINT `FKs7yibycqpxfpnv92j1dl8r1fi` FOREIGN KEY (`cliene_id`) REFERENCES `cliente` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `produto_categoria` (
  `produto_id` int(11) NOT NULL,
  `catogoria_id` int(11) NOT NULL,
  KEY `FK22ff3rn7rxh6g0tg9iul2pn34` (`catogoria_id`),
  ...
  CONSTRAINT `FK22ff3rn7rxh6g0tg9iul2pn34` FOREIGN KEY (`catogoria_id`) REFERENCES `categoria` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-05-01 16:56:03
