...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		Produto p11 = new Produto("Roçadeira", 800.00);
		Produto p8 = new Produto("Abajour", 100.00);
		Produto p9 = new Produto("Pendente", 180.00);
		Produto p10 = new Produto("Shampoo", 90.00);		
		...
		Cliente cli1 = new Cliente("Maria Silva", "alb.player.br@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, encrypt.encode("abc123"));
		...
		Cliente cli2 = new Cliente("Ana Costava", "clash.br.war@gmail.com", "32651457515", TipoCliente.PESSOAFISICA, encrypt.encode("abc123"));
		cli1.getTelefones().addAll(Arrays.asList("93888321", "34252625"));
		cli2.addPerfil(Perfil.ADMIN);
		Endereco e3 = new Endereco("Avenida Floriano", "2126", null, "Centro", "281777012", cli2, c2);
